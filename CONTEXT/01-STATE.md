...
1. **Spend the 21st.dev retrievals deliberately.** The account is on the **free tier: 2 component
   retrievals per day**, search is unmetered. So 21st can contribute at most two components a day and
   the user should choose where. Nothing has been retrieved yet.
...
### Step 2, as built### Step 2, as built
