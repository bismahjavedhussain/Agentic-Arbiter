...
figures** from the files the code actually wrote and runs **59 audit checks**, including five that
...
cd INTAKE-ARBITER/src && python audit.py      # 59 checks, 70 published numbers re-read
