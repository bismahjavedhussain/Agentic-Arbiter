...
```bash
# 1. Prove it. 43 steps, ZERO API calls. Exits non-zero on any failure.
...
`AGENTIC-ARBITER/results/engine.mjs`. Three of the 43 steps below exist to prove that, one of them by
