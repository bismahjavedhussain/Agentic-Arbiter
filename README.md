...
```bash
# 1. Prove it. 44 steps, ZERO API calls. Exits non-zero on any failure.
...
`AGENTIC-ARBITER/results/engine.mjs`. Three of the 44 steps below exist to prove that, one of them by
