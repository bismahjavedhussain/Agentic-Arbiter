...
def _aerial(site_key, site, target_w, dpi=200):
    ...
    return Image(path, width=target_w, height=target_w * ih / float(iw)), meta
...
def _build_once(site_key, out_path, pages):
    ...
    if True:
        ...
        if aer is None:
            ...
            block = Table([[aer, prose]], colWidths=[IMG_W + 12, MEASURE - IMG_W - 12])
