...
def build(metro_key=None):
    ...
    d = Pdf()
    d.line("AGENTIC-ARBITER  --  FREE-COOLING DECISION REPORT", TITLE_PT, True,
    ...
    d.para("Generated by AGENTIC-ARBITER/src/report.py. Verified by being read back: the file was "
